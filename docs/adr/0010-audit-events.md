...
- **Status:** Accepted
- **Date:** 2026-08-06
- **Source:** Grilling 2, Q6 (as amended)/Q11/Q13 — `docs/PROMPT_TRAIL.md` Session 9
## Context
...
- Clearing is refused on an unflagged item because idempotency would hide a UI bug *and*
  write a mandatory reason against a non-event. Status and the flag stay orthogonal — the
