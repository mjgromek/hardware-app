...
- **Status:** Accepted
- **Date:** 2026-08-07
- **Source:** Grilling 3, Q3 — `docs/PROMPT_TRAIL.md` Session 14

## Context

CONTEXT.md fixes the fallback: keyword search on LLM timeout or error — "the feature
...
- `test_semantic_search_falls_back_on_api_error` asserts the mode field, not just
  the rows — a fallback that lies about being the primary is the bug.
